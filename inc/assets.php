...
function flo_starter_enqueue_scripts() {
	...
	wp_enqueue_script( 'flo_starter-popper-js', '//cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js', [ 'jquery' ], true, true );
	wp_enqueue_script( 'flo_starter-bootstrap-js', '//stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', [ 'jquery', 'flo_starter-popper-js' ], true, true );
