...
/**
 * Disable Gutenberg default fullscreen mode starting from WP 5.4
 */
function flo_starter_disable_default_fullscreen_mode() {
	$script = "
...
add_action( 'enqueue_block_editor_assets', 'flo_starter_disable_default_fullscreen_mode' );
